...
export const initialData: SeedData = {
  users: [
    {email: 'testone@google.com', fullName: 'Test One', password: Bcrypt.genEncryptedThing('Abc123'), role: ['USER']},
    {email: 'testtwo@google.com', fullName: 'Test Two', password: Bcrypt.genEncryptedThing('Abc123'), role: ['USER']},
    {email: 'testthree@google.com', fullName: 'Test Three', password: Bcrypt.genEncryptedThing('Abc123'), role: ['ADMIN']},
    {email: 'testfour@google.com', fullName: 'Test Four', password: Bcrypt.genEncryptedThing('Abc123'), role: ['USER']},
  ],
  products: [
    {
      description:
